...
class FeatureBase : public FrontendCamera
{
    ...
    void readInPramFile( std::string cam_file, std::string err_file, std::string feature_param_file );
    ...
    std::vector< double > getPErrorAnglePoints( );
    ...
    std::vector< uchar > getTrackStatus( ) const;
    ...
    std::vector< uchar > m_track_status;
